                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span class="badge badge-danger badge-pill float-right">
                                        <?php
                                        $skill_result = $dbcon->query("SELECT COUNT(*) AS total_field FROM skill");
                            ...
                            <li>
                                            <a href="javascript: void(0);"><i class="fi-air-play"></i>
                                                <span class="badge badge-danger badge-pill float-right">
                                                    <?php
                                                    $artikel_works_result = $dbcon->query("SELECT COUNT(*) AS total_field FROM my_best_artikel");
                                                    $artikel_works_row = $artikel_works_result->fetch_assoc();
                                                    echo $artikel_works_row['total_field']; 

                                                    ?>
                                                </span> 
                                                <span> My Best Article</span></a>
                                            <ul class="nav-second-level" aria-expanded="false">
                                                <li><a href="artikel_works.php">My Best Article</a></li>
                                                <li><a href="my_best_artikel.php">Add Work</a></li>
                                            </ul>
                                        </li>
                                </div>
