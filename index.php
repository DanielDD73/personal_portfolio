                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card-box tilebox-one">
                                            ...
                                            <h6 class="text-muted text-uppercase mt-0">Skill</h6>
                                            <h2 class=""><span data-plugin="counterup">
                                              <?php
                                              $result = $dbcon->query("SELECT COUNT(*) AS total_Skill FROM skill");
                                              $row = $result->fetch_assoc();
                                              echo $row['total_Skill'];
                                             
                                              ?>
                                              </span></h2>
                                        </div>
                                        <a class="btn btn-sm btn-block btn-success" href="skill.php">all Skill</a>
                                    </div><!-- end col -->

                                    <div class="col-sm-4">
                                        <div class="card-box tilebox-one">
                                            <i class="dripicons-phone  float-right text-muted"></i>
                                            <h6 class="text-muted text-uppercase mt-0">Article</h6>
                                            <h2 class=""><span data-plugin="counterup">
                                              <?php
                                              $result = $dbcon->query("SELECT COUNT(*) AS total_artikel FROM my_best_artikel");
                                              $row = $result->fetch_assoc();
                                              echo $row['total_artikel'];
                                             
                                              ?>
                                              </span></h2>
                                        </div>
                                        <a class="btn btn-sm btn-block btn-success" href="my_best_artikel.php">all Article</a>
                                    </div><!-- end col -->
