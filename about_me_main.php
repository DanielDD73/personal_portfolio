	...
	<div class="card-body">
	  	...
	  	<!-- aleart end -->
			...
			<table class="table table-bordered text-center">
				<tr>
					<td colspan="2"><img  src="image/profile/<?=$result['photo']?>" style="width: 150px; font-size:24px; font-weight: bold; font-family: Arial;" ></td>
				</tr>
				...
				<tr>
					...
					<td><?=$result['instagram_link']?></td>
				</tr>

				<tr>
					<td>YouTube Link</td>
					<td><?=$result['youtube_link']?></td>
				</tr>
