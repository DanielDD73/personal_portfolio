                                			...
                                			<div class="card">
																	  ...
																	  <div class="card-body">
																	  	<form action="about_me_update.php" method="post">
																				...
																				<div class="form-group">
																					<label for="project_name">NIM</label>
																					<input type="text" class="form-control" name="nim" value="<?=$about_me_data['nim']?>">
																				</div>
																				...
																				<div class="form-group">
																					<label for="project_catagory">Instagram Link</label>
																					<input type="text" class="form-control" name="instagram_link" value="<?=$about_me_data['instagram_link']?>">
																				</div>


																				<div class="form-group">
																					<label for="project_catagory">YouTube Link</label>
																					<input type="text" class="form-control" name="youtube_link" value="<?=$about_me_data['youtube_link']?>">
																				</div>
